...
public class HBaseApp3 
{
    ...
    public static void main( String[] args )
    {
    	 try 
         {
	        ...
	        ColumnValue cv = new ColumnValue("c", "title", "Sandman");
	        columnValues.add(cv);
	        ...
	        columnValues.add(cv);
	        cv = new ColumnValue("c", "genre", "swampy");
	        columnValues.add(cv);
	        ...
	        cv = new ColumnValue("a", "writer", "Alan Moore");
	        columnValues.add(cv);
	        cv = new ColumnValue("a", "artist", "Berniw Wrightson");
	        columnValues.add(cv);
			...
			columnValuesOutput = gethbase.getValue(namespaceString, tableString, columnValues, "Sandman-1978");
