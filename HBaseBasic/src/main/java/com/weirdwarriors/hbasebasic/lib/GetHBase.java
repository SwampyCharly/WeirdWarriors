...
{	
    ...
    {    	
        ...
        for (int i = 0; i < listColumns.size(); i++)
        {
        	...
        	byte[] column = listColumns.get(i).getQualifier().getBytes();
        	// Get value 
        	...
        	if (value != null)
        	{
	        	...
	        	ColumnValue cv = new ColumnValue(rowKey, listColumns.get(i).getColumnFamily(), listColumns.get(i).getQualifier(), Bytes.toString(value));
    ...
    {    	
        ...
        logger.info("Result scanner obtained from scan operation.");
        ...
        {    	    
            ...
            {
            	// Get value
            	byte[] bytesValue = scannerResult.getValue(listColumns.get(i).getColumnFamily().getBytes(), listColumns.get(i).getQualifier().getBytes());
            	
            	if (bytesValue != null)
            	{
	            	// Form the list with the column values
		        	ColumnValue cv = new ColumnValue(rowKeyString, listColumns.get(i).getColumnFamily(), listColumns.get(i).getQualifier(), Bytes.toString(bytesValue));
