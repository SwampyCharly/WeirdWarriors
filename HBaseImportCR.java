...
public class HBaseImportCR 
{
	...
	private static String bannersTableString = "banners";
    ...
    public static void main( String[] args )
    {
    	...
    	{   
			...
			List<String> bannerFields = new ArrayList<String>();
			bannerFields.add("id");
			bannerFields.add("minAge");
			bannerFields.add("maxAge");
			bannerFields.add("gender");
        
			hbi.importFromHDFS(namespaceString, bannersTableString, columnFamilyString, HDFSPath + bannersTableString, bannerFields, separator);
		} catch (IOException e) 
    	{
			e.printStackTrace();
		}
